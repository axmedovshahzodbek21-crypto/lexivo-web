    ...
    if (imported.length > 0) {
      ...
      await supabase.from('imported_words').insert(
          imported.map(w => ({
            ...
            example3: w.example3 ?? null,
            example3_translation: w.example3Translation ?? null,
            example4: w.example4 ?? null,
            example4_translation: w.example4Translation ?? null,
            example5: w.example5 ?? null,
            example5_translation: w.example5Translation ?? null,
            language: w.language,
            added_at: w.addedAt,
          }))
        );
    ...
    if (importedRows !== null && importedRows.length > 0) {
      ...
      const cloudWords = importedRows.map(r => {
        ...
        return {
          ...
          example3: (r.example3 as string | null) ?? undefined,
          example3Translation: (r.example3_translation as string | null) ?? undefined,
          example4: (r.example4 as string | null) ?? undefined,
          example4Translation: (r.example4_translation as string | null) ?? undefined,
          example5: (r.example5 as string | null) ?? undefined,
          example5Translation: (r.example5_translation as string | null) ?? undefined,
